...
fig_corr = html.Div([
    ...
    html.Div([
        ...
        html.Img(
            src="/assets/maps/ga_firefreq_map.jpg",
            style={
                'width': '80%',
                'display': 'block',
                'margin': '20px auto',
    ...
    if year == "2001":
        return html.Div([
            html.Div([
                ...
                html.Img(src="/assets/maps/2001_NVDI_CA_Map.png", style={"width": "100%", "borderRadius": "12px"}),
...
Map.addLayer(ndvi, {min: 0, max: 8000, palette: ['ffffff', 'ffff00', '00aa00']}, "NDVI 2001");""",
            ...
            html.Div([
                ...
                html.Img(src="/assets/maps/2001_NVDI_GA_Map.png", style={"width": "100%", "borderRadius": "12px"}),
...
Map.addLayer(ndvi, {min: 0, max: 8000, palette: ['ffffff', 'ffff00', '00aa00']}, "NDVI 2001");""",
        ...
        return html.Div([
            html.Div([
                ...
                html.Img(src="/assets/maps/2022_NVDI_CA_Map.png", style={"width": "100%", "borderRadius": "12px"}),
...
Map.addLayer(ndvi, {min: 0, max: 8000, palette: ['ffffff', 'ffff00', '00aa00']}, "NDVI 2022");""",
            ...
            html.Div([
                ...
                html.Img(src="/assets/maps/2022_NVDI_GA_Map.png", style={"width": "100%", "borderRadius": "12px"}),
        ...
        return html.Div([
            html.Div([
                ...
                html.Div([
                    html.Div([
                        html.Img(
                            src="/assets/maps/2001_NVDI_CA_Map.png",
                            style={"width": "100%", "borderRadius": "12px", "height": "350px"}
                        ),
                    ], style={"width": "49%", "marginRight": "2%"}),
                    html.Div([
                        html.Img(
                            src="/assets/maps/2022_NVDI_CA_Map.png",
                            style={"width": "100%", "borderRadius": "12px", "height": "350px"}
                        ),
                    ], style={"width": "49%"})
            ...
            html.Div([
                ...
                html.Div([
                    html.Div([
                        html.Img(
                            src="/assets/maps/2001_NVDI_GA_Map.png",
                            style={"width": "100%", "borderRadius": "12px", "height": "350px"}
                        ),
                    ], style={"width": "49%", "marginRight": "2%"}),
                    html.Div([
                        html.Img(
                            src="/assets/maps/2022_NVDI_GA_Map.png",
                            style={"width": "100%", "borderRadius": "12px", "height": "350px"}
                        ),
                    ], style={"width": "49%"})
